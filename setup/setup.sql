...
CREATE TABLE `boleto` (
  ...
  KEY `FK_RELATIONSHIP_21` (`SOC_ID2`),
  ...
  CONSTRAINT `FK_RELATIONSHIP_21` FOREIGN KEY (`SOC_ID2`) REFERENCES `socio` (`SOC_ID2`)
...
CREATE TABLE `pago` (
  ...
  CONSTRAINT `FK_RELATIONSHIP_22` FOREIGN KEY (`SOC_ID2`) REFERENCES `socio` (`SOC_ID2`),
...
CREATE TABLE `partido_precio` (
  ...
  `PRT_PRE_MONTO` decimal(10,0) DEFAULT NULL,
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `socio` (
  `SOC_ID2` int(11) NOT NULL AUTO_INCREMENT,
  `PLN_ID` int(11) DEFAULT NULL,
...
-- Dump completed on 2015-12-20 14:01:23
